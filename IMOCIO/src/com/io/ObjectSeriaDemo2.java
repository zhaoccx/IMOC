 ...
 */
/*
 * class Foo implements Serializable { public Foo() {
 * System.out.println("foo..."); } }
 * 
 * @SuppressWarnings("serial") class Foo1 extends Foo { public Foo1() {
 * System.out.println("foo1..."); } }
 * 
 * class Foo2 extends Foo1 { public Foo2() { System.out.println("foo2..."); } }
 * 
 * class Bar { public Bar() { System.out.println("bar"); } }
 * 
 * class Bar1 extends Bar { public Bar1() { System.out.println("bar1.."); } }
 * 
 * class Bar2 extends Bar1 implements Serializable { public Bar2() {
 * System.out.println("bar2..."); } }
 */